...
function CinematicOpener({ onComplete }) {
  ...
  return (
    <motion.div 
      ...
      className="fixed inset-0 z-[200] bg-black flex flex-col items-center justify-center p-6 overflow-hidden font-mono"
    >
      {/* Film grain texture */}
      ...
      <div className="absolute inset-8 border border-white/10 flex flex-col justify-between p-6 pointer-events-none">
        <div className="flex justify-between items-start text-[9px] text-zinc-500 tracking-widest">
          <span>PROJECTOR // SYSTEM BOOT</span>
          <span>ANAMORPHIC SCOPE</span>
        </div>
        <div className="flex justify-between items-end text-[9px] text-zinc-500 tracking-widest">
      ...
      <div className="z-10 w-full max-w-md flex flex-col items-center text-center">
        <div className="flex items-center gap-2 mb-6">
          ...
          />
          <span className="text-[10px] tracking-[0.4em] text-red-500 font-bold uppercase">INITIALIZING REELS</span>
        </div>

        <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tighter text-white mb-2">
          HAEKAL SYUKUR
        </h1>
        <p className="text-[10px] tracking-[0.3em] text-zinc-400 uppercase mb-8">
        ...
        <div className="w-full flex justify-between text-[9px] text-zinc-500 tracking-widest">
...
export default function AnalogFilmPortfolio() {
  ...
  return (
    <>
      ...
      <div 
        ref={containerRef} 
        className={`${isMobile ? 'h-auto overflow-y-auto snap-y snap-proximity' : 'h-[600vh]'} bg-[#070707] text-white font-sans selection:bg-red-600 selection:text-white relative`}
      >
        <CursorFollower />
        ...
        <AnimatePresence>
          {toastMessage && (
            <motion.div
              ...
              className="fixed top-6 left-1/2 -translate-x-1/2 z-[350] bg-zinc-950/95 border border-red-500/80 px-5 py-2.5 shadow-[0_0_20px_rgba(239,68,68,0.3)] backdrop-blur-md flex items-center gap-3"
            >
              <span className="w-2 h-2 rounded-full bg-red-500 animate-ping" />
              <span className="font-mono text-[10px] tracking-widest text-zinc-200 uppercase font-semibold">
                {toastMessage}
              </span>
            </motion.div>
          )}
        ...
        <div className="fixed inset-0 pointer-events-none z-50 flex flex-col justify-between p-4 md:p-6">
          ...
          <div className="relative flex justify-between items-center font-mono text-[9px] md:text-[10px] tracking-widest text-zinc-500">
            <div className="flex items-center gap-2 text-red-600">
              ...
              <span className="font-bold tracking-widest">REC [CAM 01]</span>
            </div>
            
            <button 
              onClick={triggerClapper}
              className="pointer-events-auto border border-zinc-800/80 bg-zinc-950/90 backdrop-blur-sm px-3.5 py-1.5 text-zinc-300 hover:text-white hover:border-red-500 hover:bg-black transition-all duration-300 cursor-pointer flex items-center gap-2 group shadow-sm"
              title="Trigger Camera Clap / Take Sync"
            >
              <svg className="w-3.5 h-3.5 text-red-500 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M4 11v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8H4Z" />
                <path d="m4 11 1.6-4.8A2 2 0 0 1 7.5 5h10.9a2 2 0 0 1 1.9 1.4L22 11H4Z" />
                <path d="m9 5 2.5 6" />
                <path d="m14 5 2.5 6" />
              </svg>
              <span className="font-mono text-[9px] tracking-[0.2em] font-semibold group-hover:text-red-400 uppercase">
                TAKE SYNC
              </span>
            </button>
          ...
          <div className="relative flex flex-col gap-1.5 pointer-events-auto">
            <div className="flex justify-between items-end font-mono text-[9px] md:text-[10px] text-zinc-500">
              <span className="text-sm md:text-base font-bold tracking-tight text-white font-mono">{timecode}</span>
              <motion.span 
        ...
        {/* =========================================
            CONTENT WRAPPER
        ========================================= */}
        <div className={`${isMobile ? 'relative z-10 flex flex-col gap-24 py-24 px-5' : 'fixed top-0 left-0 w-full h-screen overflow-hidden z-10 flex flex-col justify-center'}`}>
          <motion.div 
            ref={trackRef} 
            style={isMobile ? {} : { x: xTransform }} 
            className={`${isMobile ? 'flex flex-col gap-28' : 'flex w-max items-center h-full'}`}
          >
            
            {/* SCENE 01: HERO */}
            <div data-scene="0" className={`${isMobile ? 'w-full min-h-[85vh] flex flex-col justify-center snap-start scroll-mt-24' : 'w-screen shrink-0 h-full flex flex-row items-center justify-center px-[8vw] lg:px-[10vw] border-r-[3px] border-dashed border-zinc-800'} relative gap-10 lg:gap-16`}>
              <div className="w-full md:flex-1 z-10 max-w-2xl">
                <motion.div 
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="inline-block px-2.5 py-1 bg-red-950/60 border border-red-800 font-mono text-[8px] tracking-[0.3em] text-red-400 uppercase mb-4"
                >
                  SCENE 01 / OPENING FRAME
                </motion.div>
                
                <h1 className="text-[clamp(2.5rem,6.5vw,6rem)] font-black uppercase leading-[.88] tracking-[-.06em] text-white">
                  Muhamad<br /><span className="text-zinc-500">Haekal</span><br />Syukur.
                </h1>
                
                <div className="h-0.5 bg-gradient-to-r from-red-600 to-transparent w-full max-w-[220px] mt-6" />
                
                <p className="mt-3.5 text-[8px] md:text-[9px] tracking-[0.25em] uppercase text-zinc-400 font-mono">
                  Applied Bachelor (D4) Informatics Engineering • ULBI (GPA 3.65)
                </p>
                
                <p className="mt-4 text-xs md:text-sm text-zinc-300 leading-relaxed font-sans max-w-xl">
                ...
                <div className="mt-6 flex flex-wrap gap-2.5">
                  <span className="font-mono text-[8px] uppercase tracking-widest px-2.5 py-1 bg-zinc-900 border border-zinc-800 text-zinc-400">
              ...
              <motion.div 
                ...
                className="w-[65vw] max-w-[240px] md:max-w-[320px] lg:max-w-[340px] flex-shrink-0 relative aspect-[4/5] bg-zinc-900 border border-zinc-700 p-2 transform rotate-1 z-10 mx-auto md:mx-0 shadow-2xl group"
              >
                ...
                <div className="absolute bottom-3 left-3 right-3 flex justify-between items-center bg-black/80 backdrop-blur px-2.5 py-1 border border-zinc-800">
            ...
            {/* SCENE 02: SKILLS */}
            <div data-scene="1" className={`${isMobile ? 'w-full min-h-[85vh] flex flex-col justify-center snap-start scroll-mt-24' : 'w-screen shrink-0 h-full flex flex-col justify-center px-[8vw] lg:px-[10vw] border-r-[3px] border-dashed border-zinc-800'} relative z-10`}>
              <div className="mb-4 max-w-5xl">
                ...
                <h2 className="text-3xl md:text-5xl font-black uppercase tracking-[-.05em] text-white">The Toolbox.</h2>
              </div>

              <div className="w-full max-w-5xl bg-zinc-950 border border-zinc-800 p-5 md:p-7 relative shadow-2xl overflow-hidden">
                {/* Garis merah pemindai animasi latar telah dihapus agar tidak ada garis merah panjang yang mengganggu */}
                    ...
                    {skillsManifest.map((skill, index) => {
                      ...
                      return (
                        <motion.button
                          ...
                          className={`text-left p-3 border transition-all cursor-pointer pointer-events-auto flex flex-col justify-between h-20 ${
                            isActive 
                        ...
                        >
                          ...
                          <span className="text-xs font-bold uppercase tracking-tight truncate">{skill.name}</span>
                        </motion.button>
                      );
                    })}
                  </div>

                  <div className="md:col-span-5 bg-black border border-zinc-800 p-5 flex flex-col justify-between min-h-[180px] relative">
            ...
            {/* SCENE 03: PROJECTS */}
            <div data-scene="2" className={`${isMobile ? 'w-full min-h-[85vh] flex flex-col justify-center snap-start scroll-mt-24' : 'w-screen shrink-0 h-full flex flex-col justify-center px-[8vw] lg:px-[10vw] border-r-[3px] border-dashed border-zinc-800'} relative z-10`}>
              <div className="mb-4 max-w-5xl">
                ...
                <h2 className="text-3xl md:text-5xl font-black uppercase tracking-[-.05em] text-white">Selected Works.</h2>
              </div>
              ...
              {!isMobile ? (
                    ...
                    {projects.map((p, idx) => (
                      ...
                      >
                        <div>
                          ...
                          <span className="font-black text-lg uppercase tracking-tight">{p.title}</span>
                        </div>
                      ...
                      {(() => {
                        ...
                        return (
                          <motion.div 
                            ...
                            className="w-full bg-zinc-950 border border-zinc-800 p-7 relative shadow-2xl flex flex-col justify-between min-h-[340px]"
                          >
                            ...
                            <div>
                              ...
                              <div className="pt-4">
                                ...
                                <h3 className="mt-1 text-3xl font-black uppercase tracking-[-.05em] text-white">
                                  {project.title}
                                </h3>
                ...
                <div className="flex flex-col gap-6 w-full">
                  {projects.map((project) => (
                    <div key={project.title} className="w-full bg-zinc-950 border border-zinc-800 p-6 shadow-xl relative">
                      ...
                      <div className="py-4">
                        ...
                        <h3 className="mt-1 text-2xl font-black uppercase text-white">{project.title}</h3>
                        <p className="mt-2.5 text-xs text-zinc-400">{project.desc}</p>
                      ...
                      <button 
                        onClick={() => setSelectedProject(project)}
                        className="w-full mt-2 bg-red-600 text-white text-center py-2.5 text-[9px] uppercase font-bold tracking-widest hover:bg-red-500 transition"
                      >
                        Inspect Full Reel →
                      </button>
                    </div>
            ...
            <div data-scene="3" className={`${isMobile ? 'w-full min-h-[85vh] flex flex-col justify-center snap-start scroll-mt-24' : 'w-screen shrink-0 h-full flex flex-col justify-center px-[8vw] lg:px-[10vw] border-r-[3px] border-dashed border-zinc-800'} relative z-10`}>
              <div className="mb-4 max-w-5xl">
                ...
                <h2 className="text-3xl md:text-5xl font-black uppercase tracking-[-.05em] text-white">Certifications.</h2>
              </div>
              ...
              <div className="flex flex-col gap-4 w-full max-w-5xl">
                {certificates.map((cert) => (
                  <motion.div 
                    ...
                    className="group relative bg-zinc-950/90 border border-zinc-800 hover:border-red-500 p-5 md:p-6 transition-all duration-300 cursor-pointer flex flex-col md:flex-row md:items-center justify-between gap-5 pointer-events-auto shadow-xl"
                  >
                    <div className="flex items-start gap-4">
                      <span className="font-mono text-[9px] md:text-[10px] text-red-400 bg-black px-3 py-1.5 border border-zinc-800 shrink-0 mt-0.5 font-bold">
                        CERT / {cert.id}
                      </span>
                      <div>
                        <span className="font-mono text-[8px] uppercase tracking-widest text-zinc-500 block mb-1">{cert.type}</span>
                        <h3 className="text-base md:text-2xl font-black uppercase text-zinc-100 group-hover:text-white transition-colors">
                          {cert.title}
                        </h3>
                    ...
                    <div className="flex items-center justify-between md:justify-end gap-5 border-t md:border-t-0 border-zinc-800/80 pt-3 md:pt-0">
                      <span className="inline-flex items-center gap-2 font-mono text-[9px] uppercase tracking-[0.2em] text-zinc-400 group-hover:text-red-400 transition-all font-semibold">
            ...
            {/* SCENE 05: EXPERIENCE */}
            <div data-scene="4" className={`${isMobile ? 'w-full min-h-[85vh] flex flex-col justify-center snap-start scroll-mt-24' : 'w-screen shrink-0 h-full flex flex-col justify-center px-[8vw] lg:px-[10vw] border-r-[3px] border-dashed border-zinc-800'} relative z-10`}>
              <div className="mb-4 max-w-5xl">
                ...
                <h2 className="text-3xl md:text-5xl font-black uppercase tracking-[-.05em] text-white">Organization.</h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-5xl">
                {orgs.map((org, index) => (
                  <motion.div 
                    whileHover={{ y: -4 }}
                    key={index} 
                    className="bg-zinc-950/90 border border-zinc-800 p-6 relative group hover:border-red-500 transition-all shadow-xl flex flex-col justify-between"
                  >
                    <div>
                      ...
                      <h3 className="text-lg md:text-2xl font-black uppercase text-white mt-1 tracking-tight">
                        {org.role} — <span className="text-zinc-400">{org.event}</span>
                      </h3>
                      
                      <p className="mt-3 text-xs text-zinc-300 font-sans leading-relaxed border-l-2 border-red-600 pl-3 bg-black/40 py-2.5">
                        {org.overview}
                      </p>
                    </div>
                    ...
                    <div className="mt-4 pt-3 border-t border-zinc-900 flex flex-col gap-2">
                      {org.desc.map((item, i) => (
                        <p key={i} className="text-[10px] md:text-xs text-zinc-400 font-mono leading-relaxed border-l border-zinc-800 pl-2.5">
                          {item}
                        </p>
                      ))}
                    </div>
            ...
            {/* SCENE 06: CONTACT */}
            <div data-scene="5" className={`${isMobile ? 'w-full min-h-[85vh] flex flex-col justify-center snap-start scroll-mt-24' : 'w-screen shrink-0 h-full flex flex-col justify-center px-[8vw] lg:px-[10vw]'} relative z-10 text-left`}>
              <div className="mb-4 max-w-5xl">
                ...
                <h2 className="text-3xl md:text-5xl font-black uppercase tracking-[-.05em] text-zinc-200">End Credits.</h2>
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-14 w-full max-w-5xl items-center bg-zinc-950 border border-zinc-800 p-6 md:p-8 shadow-2xl">
                <div className="md:col-span-7">
                  <div className="flex gap-4 mb-5 font-mono text-xs uppercase tracking-widest">
                    <a href="https://github.com/Haekalss" target="_blank" rel="noopener noreferrer" className="border-b border-zinc-700 hover:border-red-500 text-zinc-300 hover:text-white pb-1 transition">GitHub ↗</a>
                    <a href="https://www.linkedin.com/in/muhamad-haekal-syukur-4b2018328/" target="_blank" rel="noopener noreferrer" className="border-b border-zinc-700 hover:border-red-500 text-zinc-300 hover:text-white pb-1 transition">LinkedIn ↗</a>
                    <a href="https://www.instagram.com/haekalsss_/" target="_blank" rel="noopener noreferrer" className="border-b border-zinc-700 hover:border-red-500 text-zinc-300 hover:text-white pb-1 transition">Instagram ↗</a>
                  </div>
                  ...
                  <div className="space-y-2.5 w-full">
                    {credits.map(([label, value]) => (
                      <div key={label} className="flex justify-between items-baseline border-b border-zinc-900 pb-1.5">
                        ...
                        <p className="text-xs font-bold text-zinc-300 uppercase font-mono">{value}</p>
                      </div>
                    ))}
                  </div>
                </div>

                <div className="md:col-span-5 flex flex-col items-start md:items-end md:text-right border-t md:border-t-0 md:border-l-2 border-red-600 pt-6 md:pt-0 md:pl-8">
                  <p className="font-mono text-[10px] text-zinc-400 mb-5 leading-relaxed">
                    Need the full script? Download my complete resume or initiate communication for upcoming productions.
                  </p>
                  <div className="flex flex-col gap-2.5 pointer-events-auto w-full">
                    <a 
                      href={`${process.env.PUBLIC_URL}/cv-muhamad-haekal-syukur.pdf`} 
                      download="CV_Muhamad_Haekal_Syukur.pdf"
                      className="inline-flex justify-center items-center gap-3 bg-red-600 text-white px-6 py-3.5 text-[9px] md:text-[10px] font-black uppercase tracking-widest hover:bg-red-500 transition shadow-[0_0_15px_rgba(220,38,38,0.35)]"
                    >
                      Download Resume <span className="text-sm">↓</span>
                    </a>
                    <button 
                      onClick={copyEmail} 
                      className="border border-zinc-800 bg-zinc-900/60 px-6 py-3 text-[9px] md:text-[10px] uppercase tracking-widest text-zinc-300 hover:text-white hover:border-red-500 transition cursor-pointer font-mono text-center"
                    >
                      Copy Email Address
                    </button>
                  </div>
            ...
            >
              ...
              >
                <div className="sticky top-0 z-20 bg-black/90 backdrop-blur-sm border-b border-zinc-900 px-5 py-3.5 flex justify-between items-center">
                  <span className="font-mono text-[8px] uppercase tracking-widest text-red-500 font-bold">PROJECT REEL / {selectedProject.number}</span>
                ...
                <div className="p-6 md:p-8">
                  <p className="font-mono text-[9px] uppercase tracking-[.3em] text-zinc-500">{selectedProject.type}</p>
                  ...
                  <div className="mt-6 md:mt-8 grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
                    <div className="md:col-span-7">
                      ...
                      <blockquote className="mt-5 border-l-2 border-red-600 pl-4 text-xs md:text-base font-bold text-zinc-200 leading-snug bg-zinc-950 p-3">
        ...
        <AnimatePresence>
          {selectedCert && (
            <motion.div
              ...
              className="fixed inset-0 z-[300] bg-black/95 backdrop-blur-md flex items-center justify-center p-3 md:p-8 pointer-events-auto"
            >
              <motion.div
              ...
              >
                ...
                <div className="p-5 md:p-8 flex flex-col gap-6">
                  <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-zinc-800/80 pb-4">
                    <div>
                      <p className="font-mono text-[9px] uppercase tracking-[.3em] text-zinc-500">{selectedCert.type}</p>
                      <h2 className="mt-1 text-2xl md:text-3xl font-black uppercase text-white tracking-tight">
                        {selectedCert.title}
                      </h2>
                    ...
                    <div className="flex flex-wrap gap-2 shrink-0">
                      <a
                        ...
                        className="inline-flex items-center gap-2 bg-red-600 text-white px-4 py-2.5 text-[9px] md:text-[10px] font-black uppercase tracking-widest hover:bg-red-500 transition shadow-[0_0_10px_rgba(220,38,38,0.4)]"
                      >
                      ...
                      <a
                        href={`${process.env.PUBLIC_URL}${encodeURI(selectedCert.file)}`}
                        download
                        className="inline-flex items-center gap-2 border border-zinc-700 bg-zinc-900 px-4 py-2.5 text-[9px] md:text-[10px] font-mono uppercase tracking-widest text-zinc-300 hover:text-white hover:border-red-500 transition"
                      >
                        Download <span>↓</span>
                      </a>
                    </div>
                  ...
                  <div className="w-full bg-black border border-zinc-800 relative rounded overflow-hidden">
                    <div className="h-8 bg-zinc-950 border-b border-zinc-800/80 px-4 flex items-center justify-between font-mono text-[9px] text-zinc-500">
                    ...
                    <iframe 
                      ...
                      className="w-full h-[50vh] md:h-[60vh] bg-zinc-950" 
